package com.crossoverjie.cim.common.ssl;
...
/**
 * Function: ssl 服务端 客户端 SSLContext
 *
 * @author xuliang
...
public class SecureChatSslContextFactory {
    ...
    public static SSLContext getServerContext(String pkPath, String caPath) {
        ...
        logger.info(">>>>>>>>>>>>> SSLServerContextFactory build success!");
    ...
    public static SSLContext getClientContext(String pkPath, String caPath) {
        ...
        logger.info(">>>>>>>>>>>>> SSLClientContextFactory build success!");
